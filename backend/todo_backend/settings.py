...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-(1$!k@m05aam1%(h1@15lj(#l2)6w3^av2_#wh902fr2^rg29$')
...
DATABASES = {
    'default': {
        ...
        'USER': config('POSTGRES_USER', default='todo_user'),
        'PASSWORD': config('POSTGRES_PASSWORD', default='todo_password'),
